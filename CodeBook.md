...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta name="user-login" content="PANGMeng">
...
<ul class="header-nav user-nav right" id="user-links">
  <li class="header-nav-item">
      <span class="js-socket-channel js-updatable-content"
        data-channel="notification-changed:PANGMeng"
...
<a class="dropdown-item" href="/new" data-ga-click="Header, create new repository">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-s js-menu-target" href="#"
      ...
      <img alt="@PANGMeng" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/9631341?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">PANGMeng</strong>
        </div>
        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/PANGMeng" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
      ...
      <button
        ...
        <li>
          <form accept-charset="UTF-8" action="/eriky/coursera-getting-and-cleaning-data/fork" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="leQcinIh+unYD8fF4+cBCGgoLgmWq9wkKGwhQEOnKRZvaRpkzBs1wDvPiSEsU14v7jqxENrqB68GkOgVU0hjnA==" /></div>
            ...
            <a href="/eriky/coursera-getting-and-cleaning-data/network" class="social-count">82</a>
</form>        </li>
  ...
  <ul class="sunken-menu-group">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pull requests">
      ...
      <li class="tooltipped tooltipped-w" aria-label="Wiki">
        <a href="/eriky/coursera-getting-and-cleaning-data/wiki" aria-label="Wiki" class="js-selected-navigation-item sunken-menu-item" data-hotkey="g w" data-selected-links="repo_wiki /eriky/coursera-getting-and-cleaning-data/wiki">
...
<div class="clone-options">You can clone with
  ...
  <a href="github-windows://openRepo/https://github.com/eriky/coursera-getting-and-cleaning-data" class="btn btn-sm sidebar-button" title="Save eriky/coursera-getting-and-cleaning-data to your computer and use it in GitHub Desktop." aria-label="Save eriky/coursera-getting-and-cleaning-data to your computer and use it in GitHub Desktop.">
